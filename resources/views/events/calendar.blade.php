...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        <link href="{{URL::to('/')}}css/plugins/fullcalendar/fullcalendar.print.css" rel='stylesheet' media='print'>
        {{Html::style('css/font-awesome.min.css')}}
        {{Html::style('css/summernote.css')}}
        {{Html::style('clockpicker/dist/bootstrap-clockpicker.min.css')}}        <!-- Scripts -->
        <script>
    ...
    <body>
                ...
                <div class="row">
                    <div class="col-md-8 col-md-offset-2">
                        <div class="panel panel-default">
                            <div class="panel-heading">Calendario de eventos</div>
                            @if(isset($messages))
        ...
        <!--div id="modalUpdate" class="modal fade" role="dialog" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog">
        ...
        {{Html::script('js/plugins/fullcalendar/locale/es.js')}}
        ...
        <script>var _token = $('input[name="_token"]').val();</script>
        <script>
            var map;
            var markers = [];
                    ...
                    success: function (datos) {
                        ...
                        $('#calendar').fullCalendar({
                            ...
                            eventClick: function (calEvent, jsEvent, view) {
                                ...
                                $.ajax({
                                    url: path + '/findEventsById/' + calEvent.id + '',
                                    type: 'GET',
                                    success: function (r) {
                                        ajaxinit();
                                        limpiarCampos();
                                        ...
                                        if (r.status == true) {
                                            ...
                                            if (r.program == true) {
                                                ...
                                                $('#summernote2').summernote('code', r.program_object.contenido);
...
// After 3 seconds, remove the show class from DIV
            ...
            function searchSeccionalByMunicipio() {
                ...
                $.ajax({
                    type: "GET",
                    url: path + "/findSeccionalByMunicipio/" + $('#municipio').val() + "",
                    success: function (r)
                    {
                        if (r.status != false) {
